...
run_script="$apptainer_cmd python $upload_script --csv_file $csv_file --metadata_file $metadata_file --pointing_idx $pointing_idx --hardware_name hercules --verbose"

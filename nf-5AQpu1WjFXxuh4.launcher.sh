...
#SBATCH -J nf-workflow-5AQpu1WjFXxuh4
#SBATCH -o /hercules/scratch/vishnu/compact_nextflow/nf-5AQpu1WjFXxuh4.log
#SBATCH --no-requeue
#SBATCH -p local
set -e
set -o pipefail
...
export NXF_EXIT_FILE=nf-5AQpu1WjFXxuh4.exit
export NXF_CONFIG_FILE=nf-5AQpu1WjFXxuh4.config
export NXF_OUT_FILE=nf-5AQpu1WjFXxuh4.txt
export NXF_ASSETS=/hercules/scratch/vishnu/compact_nextflow/work/.nextflow/pipelines/1e838be6
export NXF_UUID=47e507f1-c832-4288-927b-ec542e525edb
export NXF_TML_FILE=timeline-5AQpu1WjFXxuh4.html
export TOWER_WORKFLOW_ID=5AQpu1WjFXxuh4
export NXF_ANSI_LOG=false
export NXF_PLUGINS_DEFAULT=nf-tower
export NXF_PRERUN_BASE64=
export NXF_LOG_FILE=nf-5AQpu1WjFXxuh4.log
...
nextflow run https\://github.com/erc-compact/compact_nextflow -name trusting_bardeen -with-tower -profile hercules > >(tee -a $NXF_OUT_FILE) 2>&1 &
nf_pid=$!
wait $nf_pid
